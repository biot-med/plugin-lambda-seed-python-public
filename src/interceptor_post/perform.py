...
def perform(data, token, traceparent, metadata):
    ...
    if "firstName" in changed_data["body"]["response"]["body"]["_name"]:
        changed_data["body"]["response"]["body"]["_name"]["firstName"] = changed_data["body"]["response"]["body"]["_name"]["firstName"] + " LAMBDA MODIFIED"
